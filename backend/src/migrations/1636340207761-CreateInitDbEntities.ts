...
export class CreateInitDbEntities1636340207761 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "liability_entity" ADD CONSTRAINT "FK_6e00720b323e050c8b914ce6093" FOREIGN KEY ("user_id") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "user_selected_currency_entity" ADD CONSTRAINT "FK_c9805056d6412bd1df647250d7f" FOREIGN KEY ("user_id") REFERENCES "user_entity"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "user_selected_currency_entity" DROP CONSTRAINT "FK_c9805056d6412bd1df647250d7f"`);
        await queryRunner.query(`ALTER TABLE "liability_entity" DROP CONSTRAINT "FK_6e00720b323e050c8b914ce6093"`);
        await queryRunner.query(`ALTER TABLE "asset_entity" DROP CONSTRAINT "FK_509940740fede7555d89c104f54"`);
        await queryRunner.query(`ALTER TABLE "refresh_token_entity" DROP CONSTRAINT "FK_06d69eb4c771cb92bab441f67a2"`);
