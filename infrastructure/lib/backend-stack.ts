...
export class BackendStack extends cdk.Stack {
  ...
  private createEcsService(vpc: Vpc) {
    const { certificate, domainName, domainZone } = this.getDomainNameAndCert();
  ...
  private createTaskDefinition() {
    ...
    taskDef.addContainer("app", {
      ...
      environmentFiles: [EnvironmentFile.fromAsset("../prod.env")],
  ...
  private getDomainNameAndCert() {
    const domainZone = HostedZone.fromLookup(this, "Zone", { domainName: "banvuong.ca" });
    ...
    const domainName = "api.banvuong.ca";
    return { domainName, certificate, domainZone };
  }
}
